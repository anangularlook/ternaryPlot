...
(function(){
    ...
    angular.module('myApp').
        controller('mainController', [function() {
            ...
            self.data.push({a: 72, b: 73, c: 4, color: 'green', symbol: 'triangle', label: '83-26' });
            ...
            self.data.push({a: 65, b: 75, c: 10, color: 'orange', symbol: 'diamond', label: '83-17' });
            ...
            self.data.push({a: 42, b: 101, c: 7, color: 'red', symbol: 'circle', label: '83-21' });
